...
export async function sendVerificationEmail(emailAddress) {
  // Check if customer exists
  let customer = getCustomer(emailAddress);
  ...
  // Update customer with verification data
  ...
  await email.sendVerificationEmail(emailAddress, verificationToken);
...
export async function verifyEmail(token) {
  ...
  const customer = customers.find(c => c.verificationToken === token);
  ...
  if (new Date(customer.verificationExpires) < new Date()) {
